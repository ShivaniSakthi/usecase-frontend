...
const Editform = () => {
    ...
    const { firstname, lastname, email, address, gender, password, dob, guadrian, contact} = user;
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await axios.put(`http://localhost:8081/usecase/student/${id}`, user);
        navigate(`/login/admin/updatestudent`);
    }

    const loadUser = async () => {
        const result = await axios.get(`http://localhost:8081/usecase/student/${id}`);
        setUser(result.data);
    }
                ...
                <div className="Card col-md-7 offset-md-3 offset-md-2">
                    ...
                    <div className="card-body">
                        <form>
                            ...
                            <Link to="/login/admin/updatestudent"><button className="payment-btn" type="submit">cancel</button></Link>
